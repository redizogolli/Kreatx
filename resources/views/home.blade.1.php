        ...
        <div class="content-wrapper">
            ...
            <div class="content body col-lg-12">
                <section id="introduction">
                    ...
                    <div class="col-lg-3">
                                             <!-- DIRECT CHAT PRIMARY -->
                            <div class="box box-primary direct-chat direct-chat-primary" style="height: 650px;width:300px;">
                                ...
                                <div class="box-body" style="">
                                    ...
                                    <!-- /.direct-chat-pane -->
                                                        ...
                                                        <div class="direct-chat-contacts" id="contacts" style="height: 607px;width:300px;margin-top:40px;">
